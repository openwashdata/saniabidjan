...
#'   \item{education}{ Level of education of respondents, options including (1) no, (2) primary, (3) coranic, (4) high school, and (5) graduate.}
...
#'   \item{status}{Indicates if respondent is the homeowner or not, options including (1) free host, (2) owner, and (3) renter.}
#'   \item{lat_facilities}{Ensuring the presence or absence of latrine facilities}
...
#'   \item{tank_presence}{Ensuring the presence or absence of septic tank in the household}
...
#'   \item{empty_freq_yr}{Indicates the emptying frequency of septic tank in the household, options including (1) 1, (2) 2 and (3) 3.}
...
#'   \item{empty_price}{Shows the charge for emptying the septic tank.}
...
#'   \item{waste_cont}{Identify whether the household has solid waste disposal facilities.}
...
#'   \item{cont_empty_wk}{Indicates the emptying frequency of solid waste disposal equipment}
